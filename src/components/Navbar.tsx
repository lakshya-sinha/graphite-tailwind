  ...
  return (
    <nav className='flex items-center justify-evenly pt-5 pb-4 border-b'>
        ...
        <div className="n-third">
            <div className="btn-wrapper flex items-center justify-center gap-3">
                <button className='rounded pl-2.6    pr-2 p-1.5 cursor-pointer bg-[#202020]'>Login In  {" "}<span className='text-[14px] bg-[#343434] text-center pt-1.6 pb-1 rounded p-2'>G</span></button>
                <button className='rounded p-1.5 cursor-pointer bg-[#202020]'>Sign up <i className="ri-arrow-right-long-line"></i></button>
            </div>
        </div>
    </nav>
  )
